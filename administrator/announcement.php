...
<h4 class="card-title" id="basic-layout-colored-form-control">New Announcement</h4>
...
<label for="userinput5">Announcement<span style="color:#CC0000;">*</span></label>
...
<div class="card">
<div class="card-header">
<h4 class="card-title" id="basic-layout-colored-form-control">Edit Announcement</h4>
<a class="heading-elements-toggle"><i class="icon-ellipsis font-medium-3"></i></a>
<div class="heading-elements">
<ul class="list-inline mb-0">
<li><a data-action="collapse"><i class="icon-minus4"></i></a></li>
...
<?php 
$sql="SELECT * FROM `iv_announcement` WHERE `id`='".trim(mysqli_real_escape_string($conn,$_REQUEST['id']))."'";
$res=query($conn,$sql);
$num=numrows($res);
if($num>0)
{
...
<td align="center" style="padding:2px"><?=ucfirst(stripslashes($fetch['announcement']))?></td>
<td align="center" style="padding:2px"><?=getDateConvert($fetch['date'])?></td>
<td align="center" style="padding:3px;">
<a href="announcement.php?case=edit&id=<?=$fetch['id']?>"><img src="images/edit.png"></a>&nbsp;
<a href="announcement-process.php?case=delete&id=<?=$fetch['id']?>" onclick="return confirm('Are you want to sure to delete this?')"><img src="images/delete.png" /></a></td>
</tr>
<?php $i++;}}else{?>
