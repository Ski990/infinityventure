...
<h4 class="card-title"><?=getSettingsPackagename($conn,'P5','packagename')?> Tree View</h4>
...
if($_REQUEST['userid'])
{
$sqlfist="SELECT * FROM `iv_genealogy_p5` WHERE `userid`='".trim(mysqli_real_escape_string($conn,$_REQUEST['userid']))."'";
}else{
$sqlfist="SELECT * FROM `iv_genealogy_p5` ORDER BY `id` LIMIT 1";
}
...
<td align="center" colspan="2"><a href="tree-view-p5.php?userid=<?=$userid?>" style="text-decoration:none;">
...
{
?>
<a href="tree-view-p5.php?userid=<?=$userid1?>" style="text-decoration:none;">
<div class="boxDiv" align="center">
...
{
?>
<a href="tree-view-p5.php?userid=<?=$userid3?>" style="text-decoration:none;"><div class="boxDiv" align="center">
<br />
...
{
?>
<a href="tree-view-p5.php?userid=<?=$userid7?>" style="text-decoration:none;"><div class="boxDiv" align="center">
<br /><div class="tooltip1">
...
{
?>
<a href="tree-view-p5.php?userid=<?=$userid8?>" style="text-decoration:none;"><div class="boxDiv" align="center">
<br />
<div class="tooltip1">
...
{
?>
<a href="tree-view-p5.php?userid=<?=$userid4?>" style="text-decoration:none;"><div class="boxDiv" align="center">
<br />
...
{
?>
<a href="tree-view-p5.php?userid=<?=$userid9?>" style="text-decoration:none;"><div class="boxDiv" align="center">
<br />
<div class="tooltip1">
...
{
?>
<a href="tree-view-p5.php?userid=<?=$userid10?>" style="text-decoration:none;"><div class="boxDiv" align="center">
<br />
...
{
?>
<a href="tree-view-p5.php?userid=<?=$userid2?>" style="text-decoration:none;"><div class="boxDiv" align="center">
<br />
...
{
?>
<a href="tree-view-p5.php?userid=<?=$userid5?>" style="text-decoration:none;"><div class="boxDiv" align="center">
<br />
...
{
?>
<a href="tree-view-p5.php?userid=<?=$userid11?>" style="text-decoration:none;"><div class="boxDiv" align="center">
<br />
...
{
?>
<a href="tree-view-p5.php?userid=<?=$userid12?>" style="text-decoration:none;"><div class="boxDiv" align="center">
<br />
<div class="tooltip1">
...
{
?>
<a href="tree-view-p5.php?userid=<?=$userid6?>" style="text-decoration:none;"><div class="boxDiv" align="center">
<br />
...
{
?>
<a href="tree-view-p5.php?userid=<?=$userid13?>" style="text-decoration:none;"><div class="boxDiv" align="center">
<br />
...
{
?>
<a href="tree-view-p5.php?userid=<?=$userid14?>" style="text-decoration:none;"><div class="boxDiv" align="center">
<br />
