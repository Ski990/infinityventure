...
<h4 class="card-title">Level Bonus Statement</h4>
...
<form name="frm1" method="post" action="commission-level.php?act=search">
...
<form name="frm1" method="post" action="commission-level.php?act=search"><input type="text" name="search" id="search" class="form-control input-line input-medium" value="<?=$_REQUEST['search']?>" required placeholder="User ID, From ID" style="width:100%;" />
</form>
</div>
</div>
</div>
...
<td align="center" style="padding:3px;"><?=ucwords(getMemberUserID($conn,$fetch['fromid'],'name'))?></td>

<td style="text-align:center;padding:2px;"><?=$fetch['level']?></td>

<td style="text-align:center;padding:2px;"><?=getSettingsPackage($conn,$fetch['package'],'package')?></td>
