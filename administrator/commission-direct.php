...
<h4 class="card-title">Direct Bonus Statement</h4>
...
<form name="frm1" method="post" action="commission-direct.php?act=search">
...
<form name="frm1" method="post" action="commission-direct.php?act=search"><input type="text" name="search" id="search" class="form-control input-line input-medium" value="<?=$_REQUEST['search']?>" required placeholder="User ID" style="width:100%;" />
</form>
</div>
</div>
</div>
