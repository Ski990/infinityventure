...
<h4 class="card-title"><?=getSettingsPackagename($conn,'P1','packagename')?> Tree View</h4>
...
if($_REQUEST['userid'])
{
$sqlfist="SELECT * FROM `iv_genealogy_p1` WHERE `userid`='".trim(mysqli_real_escape_string($conn,$_REQUEST['userid']))."'";
}else{
$sqlfist="SELECT * FROM `iv_genealogy_p1` ORDER BY `id` LIMIT 1";
}
...
<td align="center" colspan="2"><a href="tree-view-p1.php?userid=<?=$userid?>" style="text-decoration:none;">
...
<tr height="20">
<td>&nbsp;</td>
<td align="left">Left Team :&nbsp;<?=getDownlineCountPairP1($conn,$userid,'left')?></td>
<td align="left">Right Team :&nbsp;<?=getDownlineCountPairP1($conn,$userid,'right')?></td>
</tr>
...
<td align="left">
Pay Status:&nbsp;<?php if(getMemberUserID($conn,$userid,'paystatus')=='A'){?><span style="color:#009900;">Paid</span><?php }else{?><span style="color:#FF0000;">Pending</span><?php }?></td>	
</tr>
...
<div class="boxDiv" align="center">
<?php
$userid1=getDownlineByPositionP1($conn,$userid,'Left');
if($userid1)
{
?>
<a href="tree-view-p1.php?userid=<?=$userid1?>" style="text-decoration:none;">
<div class="boxDiv" align="center">
...
<tr height="20">
<td>&nbsp;</td>
<td align="left">Left Team :&nbsp;<?=getDownlineCountPairP1($conn,$userid1,'left')?></td>
<td align="left">Right Team :&nbsp;<?=getDownlineCountPairP1($conn,$userid1,'right')?></td>
...
<td align="left">
Pay Status:&nbsp;<?php if(getMemberUserID($conn,$userid1,'paystatus')=='A'){?><span style="color:#009900;">Paid</span><?php }else{?><span style="color:#FF0000;">Pending</span><?php }?></td>
</tr>
...
<div class="boxDiv" align="center">
<?php
$userid3=getDownlineByPositionP1($conn,$userid1,'Left');
if($userid3)
{
?>
<a href="tree-view-p1.php?userid=<?=$userid3?>" style="text-decoration:none;"><div class="boxDiv" align="center">
<br />
...
<tr height="20">
<td>&nbsp;</td>
<td align="left">Left Team :&nbsp;<?=getDownlineCountPairP1($conn,$userid3,'left')?></td>
<td align="left">Right Team :&nbsp;<?=getDownlineCountPairP1($conn,$userid3,'right')?></td>
...
<td align="left">
Pay Status:&nbsp;<?php if(getMemberUserID($conn,$userid3,'paystatus')=='A'){?><span style="color:#009900;">Paid</span><?php }else{?><span style="color:#FF0000;">Pending</span><?php }?></td>
</tr>
</table>
</span>
</div>
...
<div class="boxDiv" align="center">
<?php
$userid7=getDownlineByPositionP1($conn,$userid3,'Left');
if($userid7)
{
?>
<a href="tree-view-p1.php?userid=<?=$userid7?>" style="text-decoration:none;"><div class="boxDiv" align="center">
<br /><div class="tooltip1">
...
<tr height="20">
<td>&nbsp;</td>
<td align="left">Left Team :&nbsp;<?=getDownlineCountPairP1($conn,$userid7,'left')?></td>
<td align="left">Right Team :&nbsp;<?=getDownlineCountPairP1($conn,$userid7,'right')?></td>
...
<td align="left">
Pay Status:&nbsp;<?php if(getMemberUserID($conn,$userid7,'paystatus')=='A'){?><span style="color:#009900;">Paid</span><?php }else{?><span style="color:#FF0000;">Pending</span><?php }?></td>
</tr>
</table>
</span>
</div>
...
<div class="boxDiv" align="center">
<?php
$userid8=getDownlineByPositionP1($conn,$userid3,'Right');
if($userid8)
{
?>
<a href="tree-view-p1.php?userid=<?=$userid8?>" style="text-decoration:none;"><div class="boxDiv" align="center">
<br />
<div class="tooltip1">
...
<tr height="20">
<td>&nbsp;</td>
<td align="left">Left Team :&nbsp;<?=getDownlineCountPairP1($conn,$userid8,'left')?></td>
<td align="left">Right Team :&nbsp;<?=getDownlineCountPairP1($conn,$userid8,'right')?></td>
...
<td align="left">
Pay Status:&nbsp;<?php if(getMemberUserID($conn,$userid8,'paystatus')=='A'){?><span style="color:#009900;">Paid</span><?php }else{?><span style="color:#FF0000;">Pending</span><?php }?></td>
</tr>
</table>
</span>
</div>
...
<div class="boxDiv" align="center">
<?php
$userid4=getDownlineByPositionP1($conn,$userid1,'Right');
if($userid4)
{
?>
<a href="tree-view-p1.php?userid=<?=$userid4?>" style="text-decoration:none;"><div class="boxDiv" align="center">
<br />
...
<tr height="20">
<td>&nbsp;</td>
<td align="left">Left Team :&nbsp;<?=getDownlineCountPairP1($conn,$userid4,'left')?></td>
<td align="left">Right Team :&nbsp;<?=getDownlineCountPairP1($conn,$userid4,'right')?></td>
...
<td align="left">
Pay Status:&nbsp;<?php if(getMemberUserID($conn,$userid4,'paystatus')=='A'){?><span style="color:#009900;">Paid</span><?php }else{?><span style="color:#FF0000;">Pending</span><?php }?></td>
</tr>
</table>
</span>
</div>
...
<div class="boxDiv" align="center">
<?php
$userid9=getDownlineByPositionP1($conn,$userid4,'Left');
if($userid9)
{
?>
<a href="tree-view-p1.php?userid=<?=$userid9?>" style="text-decoration:none;"><div class="boxDiv" align="center">
<br />
<div class="tooltip1">
...
<tr height="20">
<td>&nbsp;</td>
<td align="left">Left Team :&nbsp;<?=getDownlineCountPairP1($conn,$userid9,'left')?></td>
<td align="left">Right Team :&nbsp;<?=getDownlineCountPairP1($conn,$userid9,'right')?></td>
...
<td align="left">
Pay Status:&nbsp;<?php if(getMemberUserID($conn,$userid9,'paystatus')=='A'){?><span style="color:#009900;">Paid</span><?php }else{?><span style="color:#FF0000;">Pending</span><?php }?></td>
</tr>
</table>
</span>
</div>
...
<div class="boxDiv" align="center">
<?php
$userid10=getDownlineByPositionP1($conn,$userid4,'Right');
if($userid10)
{
?>
<a href="tree-view-p1.php?userid=<?=$userid10?>" style="text-decoration:none;"><div class="boxDiv" align="center">
<br />
...
<tr height="20">
<td>&nbsp;</td>
<td align="left">Left Team :&nbsp;<?=getDownlineCountPairP1($conn,$userid10,'left')?></td>
<td align="left">Right Team :&nbsp;<?=getDownlineCountPairP1($conn,$userid10,'right')?></td>
...
<td align="left">
Pay Status:&nbsp;<?php if(getMemberUserID($conn,$userid10,'paystatus')=='A'){?><span style="color:#009900;">Paid</span><?php }else{?><span style="color:#FF0000;">Pending</span><?php }?></td>
</tr>
</table>
</span>
</div>
...
<div class="boxDiv" align="center">
<?php
$userid2=getDownlineByPositionP1($conn,$userid,'Right');
if($userid2)
{
?>
<a href="tree-view-p1.php?userid=<?=$userid2?>" style="text-decoration:none;"><div class="boxDiv" align="center">
<br />
...
<tr height="20">
<td>&nbsp;</td>
<td align="left">Left Team :&nbsp;<?=getDownlineCountPairP1($conn,$userid2,'left')?></td>
<td align="left">Right Team :&nbsp;<?=getDownlineCountPairP1($conn,$userid2,'right')?></td>
...
<td align="left">
Pay Status:&nbsp;<?php if(getMemberUserID($conn,$userid2,'paystatus')=='A'){?><span style="color:#009900;">Paid</span><?php }else{?><span style="color:#FF0000;">Pending</span><?php }?></td>
</tr>
</table>
...
<div class="boxDiv" align="center">
<?php
$userid5=getDownlineByPositionP1($conn,$userid2,'Left');
if($userid5)
{
?>
<a href="tree-view-p1.php?userid=<?=$userid5?>" style="text-decoration:none;"><div class="boxDiv" align="center">
<br />
...
<tr height="20">
<td>&nbsp;</td>
<td align="left">Left Team :&nbsp;<?=getDownlineCountPairP1($conn,$userid5,'left')?></td>
<td align="left">Right Team :&nbsp;<?=getDownlineCountPairP1($conn,$userid5,'right')?></td>
...
<td align="left">
Pay Status:&nbsp;<?php if(getMemberUserID($conn,$userid5,'paystatus')=='A'){?><span style="color:#009900;">Paid</span><?php }else{?><span style="color:#FF0000;">Pending</span><?php }?></td>
</tr>
</table>
</span>
</div>
...
<div class="boxDiv" align="center">
<?php
$userid11=getDownlineByPositionP1($conn,$userid5,'Left');
if($userid11)
{
?>
<a href="tree-view-p1.php?userid=<?=$userid11?>" style="text-decoration:none;"><div class="boxDiv" align="center">
<br />
...
<tr height="20">
<td>&nbsp;</td>
<td align="left">Left Team :&nbsp;<?=getDownlineCountPairP1($conn,$userid11,'left')?></td>
<td align="left">Right Team :&nbsp;<?=getDownlineCountPairP1($conn,$userid11,'right')?></td>
...
<td align="left">
Pay Status:&nbsp;<?php if(getMemberUserID($conn,$userid11,'paystatus')=='A'){?><span style="color:#009900;">Paid</span><?php }else{?><span style="color:#FF0000;">Pending</span><?php }?></td>
</tr>
</table>
...
<div class="boxDiv" align="center">
<?php
$userid12=getDownlineByPositionP1($conn,$userid5,'Right');
if($userid12)
{
?>
<a href="tree-view-p1.php?userid=<?=$userid12?>" style="text-decoration:none;"><div class="boxDiv" align="center">
<br />
<div class="tooltip1">
...
<tr height="20">
<td>&nbsp;</td>
<td align="left">Left Team :&nbsp;<?=getDownlineCountPairP1($conn,$userid12,'left')?></td>
<td align="left">Right Team :&nbsp;<?=getDownlineCountPairP1($conn,$userid12,'right')?></td>
...
<td align="left">
Pay Status:&nbsp;<?php if(getMemberUserID($conn,$userid12,'paystatus')=='A'){?><span style="color:#009900;">Paid</span><?php }else{?><span style="color:#FF0000;">Pending</span><?php }?></td>
</tr>
</table>
...
<div class="boxDiv" align="center">
<?php
$userid6=getDownlineByPositionP1($conn,$userid2,'Right');
if($userid6)
{
?>
<a href="tree-view-p1.php?userid=<?=$userid6?>" style="text-decoration:none;"><div class="boxDiv" align="center">
<br />
...
<tr height="20">
<td>&nbsp;</td>
<td align="left">Left Team :&nbsp;<?=getDownlineCountPairP1($conn,$userid6,'left')?></td>
<td align="left">Right Team :&nbsp;<?=getDownlineCountPairP1($conn,$userid6,'right')?></td>
...
<td align="left">
Pay Status:&nbsp;<?php if(getMemberUserID($conn,$userid6,'paystatus')=='A'){?><span style="color:#009900;">Paid</span><?php }else{?><span style="color:#FF0000;">Pending</span><?php }?></td>
</tr>
</table>
</span>
...
<div class="boxDiv" align="center">
<?php
$userid13=getDownlineByPositionP1($conn,$userid6,'Left');
if($userid13)
{
?>
<a href="tree-view-p1.php?userid=<?=$userid13?>" style="text-decoration:none;"><div class="boxDiv" align="center">
<br />
...
<tr height="20">
<td>&nbsp;</td>
<td align="left">Left Team :&nbsp;<?=getDownlineCountPairP1($conn,$userid13,'left')?></td>
<td align="left">Right Team :&nbsp;<?=getDownlineCountPairP1($conn,$userid13,'right')?></td>
...
<td align="left">
Pay Status:&nbsp;<?php if(getMemberUserID($conn,$userid13,'paystatus')=='A'){?><span style="color:#009900;">Paid</span><?php }else{?><span style="color:#FF0000;">Pending</span><?php }?></td>
</tr>
...
<div class="boxDiv" align="center">
<?php
$userid14=getDownlineByPositionP1($conn,$userid6,'Right');
if($userid14)
{
?>
<a href="tree-view-p1.php?userid=<?=$userid14?>" style="text-decoration:none;"><div class="boxDiv" align="center">
<br />
...
<tr height="20">
<td>&nbsp;</td>
<td align="left">Left Team :&nbsp;<?=getDownlineCountPairP1($conn,$userid14,'left')?></td>
<td align="left">Right Team :&nbsp;<?=getDownlineCountPairP1($conn,$userid14,'right')?></td>
...
<td align="left">
Pay Status:&nbsp;<?php if(getMemberUserID($conn,$userid14,'paystatus')=='A'){?><span style="color:#009900;">Paid</span><?php }else{?><span style="color:#FF0000;">Pending</span><?php }?></td>
</tr>
</table>
</span>
</div>
