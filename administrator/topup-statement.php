...
<h4 class="card-title">Topup Statement</h4>
...
<tr>
<td>
<div align="left" style="margin-left:10px;"><a href="topup-statement-csv-download.php"><input type="button" value="Excel Download" class="btn" style="background:#009900;color:#FFFFFF;" /></a></div>
</td>
<td>
<div align="right" style="padding:5px;"><form name="frm1" method="post" action="topup-statement.php?act=search"><input type="text" name="search" id="search" class="form-control input-line input-medium" value="<?=$_REQUEST['search']?>" required placeholder="User ID" style="width:150px;" />
</form></div>
</td>
</tr>
</table>
...
<td width="10%" align="center"><strong>Topup_ID</strong></td>
<td width="10%" align="center"><strong>Name</strong></td>
...
<td align="center" style="padding:5px;"><?=ucwords(getMemberUserID($conn,$fetch['topupid'],'name'))?></td>
