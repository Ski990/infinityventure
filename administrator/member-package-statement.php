...
<h4 class="card-title"> Package Statement</h4>
...
<tr>
<td>
<div align="left" style="margin-left:10px;"><a href="member-package-csv-download.php"><input type="button" value="Excel Download" class="btn" style="background:#009900;color:#FFFFFF;" /></a></div>
</td>
<td>
<div align="right" style="padding:5px;"><form name="frm1" method="post" action="member-package-statement.php?act=search"><input type="text" name="search" id="search" class="form-control input-line input-medium" value="<?=$_REQUEST['search']?>" required placeholder="User ID" style="width:150px;" />
</form></div>
</td>
</tr>
</table>
...
<tbody>
<?php
$tname='iv_member_package';
$lim=100;
$tpage='member-package-statement.php';
