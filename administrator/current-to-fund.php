...
<h4 class="card-title">Current to Fund Transfer Statement</h4>
...
<div align="center" style="padding:5px;"><form name="frm1" method="post" action="current-to-fund.php?act=search"><input type="text" name="search" id="search" class="form-control input-line input-medium" value="<?=$_REQUEST['search']?>" required placeholder="User ID" style="width:250px;" />
</form></div>
...
<th width="176" align="center">Amount</th>						
<th width="406" align="center">Charge</th>
...
<td style="padding:3px;"><?=$fetch['current']?></td>
<td style="padding:3px;"><?=$fetch['charge']?></td>
