...
<h4 class="card-title">Global Investment Bonus Statement</h4>
...
<form name="frm1" method="post" action="commission-global-investment.php?act=search">
...
<form name="frm1" method="post" action="commission-global-investment.php?act=search"><input type="text" name="search" id="search" class="form-control input-line input-medium" value="<?=$_REQUEST['search']?>" required placeholder="User ID" style="width:100%;" />
</form>
</div>
</div>
</div>
...
<th style="text-align:center;">Total_Invest</th>
<th style="text-align:center;">Ratio</th>
<th style="text-align:center;">Invested_Amount</th>
<th style="text-align:center;">Bonus</th>
<th style="text-align:center;">Withdrawal_Amount</th>
<th style="text-align:center;">Global_Amount</th>
...
<?php
$tname='iv_commission_global_investment';
$lim=100;
$tpage='commission-global-investment.php';
...
<td style="text-align:center;padding:2px;"><?=$fetch['totalcto']?></td>
<td style="text-align:center;padding:2px;"><?=$fetch['ctoper']?></td>
<td style="text-align:center;padding:2px;"><?=$fetch['totalamount']?></td>
<td style="text-align:center;padding:2px;"><?=$fetch['totalinvest']?></td>
<td style="text-align:center;padding:2px;"><?=$fetch['ratio']?></td>
<td style="text-align:center;padding:2px;"><?=$fetch['investamount']?></td>
<td style="text-align:center;padding:2px;"><?=$fetch['bonus']?></td>
<td style="text-align:center;padding:2px;"><?=$fetch['withdarawalamount']?></td>
<td style="text-align:center;padding:2px;"><?=$fetch['globalamount']?></td>
