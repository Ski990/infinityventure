...
<h4 class="card-title">Member Topup Statement</h4>
...
<div align="right" style="padding:5px;"><form name="frm1" method="post" action="member-topup.php?act=search"><input type="text" name="search" id="search" class="form-control input-line input-medium" value="<?=$_REQUEST['search']?>" required placeholder="User ID, Topup ID" style="width:150px;" />
</form></div>
...
<td width="15%" align="center"><strong>Topup_ID</strong></td>
<td width="10%" align="center"><strong>Name</strong></td>
...
$lim=100;
$tpage='member-topup.php';

if($_REQUEST['act']=='search')
{
$where="WHERE `userid` LIKE '".trim($_POST['search'])."' OR `topupid` LIKE '".trim($_POST['search'])."' ORDER BY `id` DESC";
}else{
