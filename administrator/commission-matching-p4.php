...
<h4 class="card-title">Matching <?=getSettingsPackagename($conn,'P4','packagename')?> Bonus Statement</h4>
...
<form name="frm1" method="post" action="commission-matching-p4.php?act=search">
...
<form name="frm1" method="post" action="commission-matching-p4.php?act=search"><input type="text" name="search" id="search" class="form-control input-line input-medium" value="<?=$_REQUEST['search']?>" required placeholder="User ID" style="width:100%;" />
</form>
</div>
</div>
</div>
...
<?php
$tname='iv_commission_matching_p4';
$lim=100;
$tpage='commission-matching-p4.php';
