...
<h4 class="card-title" align="left"><?=getSettingsPackagename($conn,'P5','packagename')?> Level View</h4>
...
{
$sql="SELECT * FROM `iv_genealogy_p5` WHERE `placement`='".trim($_REQUEST['placement'])."'";
}else{
$sql="SELECT * FROM `iv_genealogy_p5` ORDER BY `id` LIMIT 1";
}
$res=query($conn,$sql);
$num=numrows($res);
$i=0;
...
<td align="center" style="padding:5px;"><a href="genealogy-level-p5.php?placement=<?=$fetch['userid']?>"><?=$fetch['userid']?></a></td>
...
for($k=0;$k<$count;$k++)
{
$sql1="SELECT * FROM `iv_genealogy_p5` WHERE `placement`='".$arr[$k]."'";
...
<tr>
<td align="center" style="padding:3px;"><?=($i+1)?></td>
<td align="center" style="padding:5px;"><a href="genealogy-level-p5.php?placement=<?=$fetch1['userid']?>"><?=$fetch1['userid']?></a></td>
...
for($k=0;$k<$count1;$k++)
{
$sql2="SELECT * FROM `iv_genealogy_p5` WHERE `placement`='".$arr1[$k]."'";
...
<tr>
<td align="center" style="padding:3px;"><?=($i+1)?></td>
<td align="center" style="padding:5px;"><a href="genealogy-level-p5.php?placement=<?=$fetch2['userid']?>"><?=$fetch2['userid']?></a></td>
...
for($k=0;$k<$count2;$k++)
{
$sql3="SELECT * FROM `iv_genealogy_p5` WHERE `placement`='".$arr2[$k]."'";
...
<tr>
<td align="center" style="padding:3px;"><?=($i+1)?></td>
<td align="center" style="padding:5px;"><a href="genealogy-level-p5.php?placement=<?=$fetch3['userid']?>"><?=$fetch3['userid']?></a></td>
...
for($k=0;$k<$count3;$k++)
{
$sql4="SELECT * FROM `iv_genealogy_p5` WHERE `placement`='".$arr3[$k]."'";
...
<tr>
<td align="center" style="padding:3px;"><?=($i+1)?></td>
<td align="center" style="padding:5px;"><a href="genealogy-level-p5.php?placement=<?=$fetch4['userid']?>"><?=$fetch4['userid']?></a></td>
...
for($k=0;$k<$count4;$k++)
{
$sql5="SELECT * FROM `iv_genealogy_p5` WHERE `placement`='".$arr4[$k]."'";
...
<tr>
<td align="center" style="padding:3px;"><?=($i+1)?></td>
<td align="center" style="padding:5px;"><a href="genealogy-level-p5.php?placement=<?=$fetch5['userid']?>"><?=$fetch5['userid']?></a></td>
...
for($k=0;$k<$count5;$k++)
{
$sql6="SELECT * FROM `iv_genealogy_p5` WHERE `placement`='".$arr5[$k]."'";
...
<tr>
<td align="center" style="padding:3px;"><?=($i+1)?></td>
<td align="center" style="padding:5px;"><a href="genealogy-level-p5.php?placement=<?=$fetch6['userid']?>"><?=$fetch6['userid']?></a></td>
...
for($k=0;$k<$count6;$k++)
{
$sql7="SELECT * FROM `iv_genealogy_p5` WHERE `placement`='".$arr6[$k]."'";
...
<tr>
<td align="center" style="padding:3px;"><?=($i+1)?></td>
<td align="center" style="padding:5px;"><a href="genealogy-level-p5.php?placement=<?=$fetch7['userid']?>"><?=$fetch7['userid']?></a></td>
...
for($k=0;$k<$count7;$k++)
{
$sql8="SELECT * FROM `iv_genealogy_p5` WHERE `placement`='".$arr7[$k]."'";
...
<tr>
<td align="center" style="padding:3px;"><?=($i+1)?></td>
<td align="center" style="padding:5px;"><a href="genealogy-level-p5.php?placement=<?=$fetch8['userid']?>"><?=$fetch8['userid']?></a></td>
