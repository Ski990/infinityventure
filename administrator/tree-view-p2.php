...
<h4 class="card-title"><?=getSettingsPackagename($conn,'P2','packagename')?> Tree View</h4>
...
if($_REQUEST['userid'])
{
$sqlfist="SELECT * FROM `iv_genealogy_p2` WHERE `userid`='".trim(mysqli_real_escape_string($conn,$_REQUEST['userid']))."'";
}else{
$sqlfist="SELECT * FROM `iv_genealogy_p2` ORDER BY `id` LIMIT 1";
}
...
<td align="center" colspan="2"><a href="tree-view-p2.php?userid=<?=$userid?>" style="text-decoration:none;">
...
<tr height="20">
<td>&nbsp;</td>
<td align="left">Left Team :&nbsp;<?=getDownlineCountP2Pair($conn,$userid,'left')?></td>
<td align="left">Right Team :&nbsp;<?=getDownlineCountP2Pair($conn,$userid,'right')?></td>
...
<div class="boxDiv" align="center">
<?php
$userid1=getDownlineByPositionP2($conn,$userid,'Left');
if($userid1)
{
?>
<a href="tree-view-p2.php?userid=<?=$userid1?>" style="text-decoration:none;">
<div class="boxDiv" align="center">
...
<tr height="20">
<td>&nbsp;</td>
<td align="left">Left Team :&nbsp;<?=getDownlineCountP2Pair($conn,$userid1,'left')?></td>
<td align="left">Right Team :&nbsp;<?=getDownlineCountP2Pair($conn,$userid1,'right')?></td>
...
<div class="boxDiv" align="center">
<?php
$userid3=getDownlineByPositionP2($conn,$userid1,'Left');
if($userid3)
{
?>
<a href="tree-view-p2.php?userid=<?=$userid3?>" style="text-decoration:none;"><div class="boxDiv" align="center">
<br />
...
<tr height="20">
<td>&nbsp;</td>
<td align="left">Left Team :&nbsp;<?=getDownlineCountP2Pair($conn,$userid3,'left')?></td>
<td align="left">Right Team :&nbsp;<?=getDownlineCountP2Pair($conn,$userid3,'right')?></td>
...
<div class="boxDiv" align="center">
<?php
$userid7=getDownlineByPositionP2($conn,$userid3,'Left');
if($userid7)
{
?>
<a href="tree-view-p2.php?userid=<?=$userid7?>" style="text-decoration:none;"><div class="boxDiv" align="center">
<br /><div class="tooltip1">
...
<tr height="20">
<td>&nbsp;</td>
<td align="left">Left Team :&nbsp;<?=getDownlineCountP2Pair($conn,$userid7,'left')?></td>
<td align="left">Right Team :&nbsp;<?=getDownlineCountP2Pair($conn,$userid7,'right')?></td>
...
<div class="boxDiv" align="center">
<?php
$userid8=getDownlineByPositionP2($conn,$userid3,'Right');
if($userid8)
{
?>
<a href="tree-view-p2.php?userid=<?=$userid8?>" style="text-decoration:none;"><div class="boxDiv" align="center">
<br />
<div class="tooltip1">
...
<tr height="20">
<td>&nbsp;</td>
<td align="left">Left Team :&nbsp;<?=getDownlineCountP2Pair($conn,$userid8,'left')?></td>
<td align="left">Right Team :&nbsp;<?=getDownlineCountP2Pair($conn,$userid8,'right')?></td>
...
<div class="boxDiv" align="center">
<?php
$userid4=getDownlineByPositionP2($conn,$userid1,'Right');
if($userid4)
{
?>
<a href="tree-view-p2.php?userid=<?=$userid4?>" style="text-decoration:none;"><div class="boxDiv" align="center">
<br />
...
<tr height="20">
<td>&nbsp;</td>
<td align="left">Left Team :&nbsp;<?=getDownlineCountP2Pair($conn,$userid4,'left')?></td>
<td align="left">Right Team :&nbsp;<?=getDownlineCountP2Pair($conn,$userid4,'right')?></td>
...
<div class="boxDiv" align="center">
<?php
$userid9=getDownlineByPositionP2($conn,$userid4,'Left');
if($userid9)
{
?>
<a href="tree-view-p2.php?userid=<?=$userid9?>" style="text-decoration:none;"><div class="boxDiv" align="center">
<br />
<div class="tooltip1">
...
<tr height="20">
<td>&nbsp;</td>
<td align="left">Left Team :&nbsp;<?=getDownlineCountP2Pair($conn,$userid9,'left')?></td>
<td align="left">Right Team :&nbsp;<?=getDownlineCountP2Pair($conn,$userid9,'right')?></td>
...
<div class="boxDiv" align="center">
<?php
$userid10=getDownlineByPositionP2($conn,$userid4,'Right');
if($userid10)
{
?>
<a href="tree-view-p2.php?userid=<?=$userid10?>" style="text-decoration:none;"><div class="boxDiv" align="center">
<br />
...
<tr height="20">
<td>&nbsp;</td>
<td align="left">Left Team :&nbsp;<?=getDownlineCountP2Pair($conn,$userid10,'left')?></td>
<td align="left">Right Team :&nbsp;<?=getDownlineCountP2Pair($conn,$userid10,'right')?></td>
...
<div class="boxDiv" align="center">
<?php
$userid2=getDownlineByPositionP2($conn,$userid,'Right');
if($userid2)
{
?>
<a href="tree-view-p2.php?userid=<?=$userid2?>" style="text-decoration:none;"><div class="boxDiv" align="center">
<br />
...
<tr height="20">
<td>&nbsp;</td>
<td align="left">Left Team :&nbsp;<?=getDownlineCountP2Pair($conn,$userid2,'left')?></td>
<td align="left">Right Team :&nbsp;<?=getDownlineCountP2Pair($conn,$userid2,'right')?></td>
...
<div class="boxDiv" align="center">
<?php
$userid5=getDownlineByPositionP2($conn,$userid2,'Left');
if($userid5)
{
?>
<a href="tree-view-p2.php?userid=<?=$userid5?>" style="text-decoration:none;"><div class="boxDiv" align="center">
<br />
...
<tr height="20">
<td>&nbsp;</td>
<td align="left">Left Team :&nbsp;<?=getDownlineCountP2Pair($conn,$userid5,'left')?></td>
<td align="left">Right Team :&nbsp;<?=getDownlineCountP2Pair($conn,$userid5,'right')?></td>
...
<div class="boxDiv" align="center">
<?php
$userid11=getDownlineByPositionP2($conn,$userid5,'Left');
if($userid11)
{
?>
<a href="tree-view-p2.php?userid=<?=$userid11?>" style="text-decoration:none;"><div class="boxDiv" align="center">
<br />
...
<tr height="20">
<td>&nbsp;</td>
<td align="left">Left Team :&nbsp;<?=getDownlineCountP2Pair($conn,$userid11,'left')?></td>
<td align="left">Right Team :&nbsp;<?=getDownlineCountP2Pair($conn,$userid11,'right')?></td>
...
<div class="boxDiv" align="center">
<?php
$userid12=getDownlineByPositionP2($conn,$userid5,'Right');
if($userid12)
{
?>
<a href="tree-view-p2.php?userid=<?=$userid12?>" style="text-decoration:none;"><div class="boxDiv" align="center">
<br />
<div class="tooltip1">
...
<tr height="20">
<td>&nbsp;</td>
<td align="left">Left Team :&nbsp;<?=getDownlineCountP2Pair($conn,$userid12,'left')?></td>
<td align="left">Right Team :&nbsp;<?=getDownlineCountP2Pair($conn,$userid12,'right')?></td>
...
<div class="boxDiv" align="center">
<?php
$userid6=getDownlineByPositionP2($conn,$userid2,'Right');
if($userid6)
{
?>
<a href="tree-view-p2.php?userid=<?=$userid6?>" style="text-decoration:none;"><div class="boxDiv" align="center">
<br />
...
<tr height="20">
<td>&nbsp;</td>
<td align="left">Left Team :&nbsp;<?=getDownlineCountP2Pair($conn,$userid6,'left')?></td>
<td align="left">Right Team :&nbsp;<?=getDownlineCountP2Pair($conn,$userid6,'right')?></td>
...
<div class="boxDiv" align="center">
<?php
$userid13=getDownlineByPositionP2($conn,$userid6,'Left');
if($userid13)
{
?>
<a href="tree-view-p2.php?userid=<?=$userid13?>" style="text-decoration:none;"><div class="boxDiv" align="center">
<br />
...
<tr height="20">
<td>&nbsp;</td>
<td align="left">Left Team :&nbsp;<?=getDownlineCountP2Pair($conn,$userid13,'left')?></td>
<td align="left">Right Team :&nbsp;<?=getDownlineCountP2Pair($conn,$userid13,'right')?></td>
...
<div class="boxDiv" align="center">
<?php
$userid14=getDownlineByPositionP2($conn,$userid6,'Right');
if($userid14)
{
?>
<a href="tree-view-p2.php?userid=<?=$userid14?>" style="text-decoration:none;"><div class="boxDiv" align="center">
<br />
...
<tr height="20">
<td>&nbsp;</td>
<td align="left">Left Team :&nbsp;<?=getDownlineCountP2Pair($conn,$userid14,'left')?></td>
<td align="left">Right Team :&nbsp;<?=getDownlineCountP2Pair($conn,$userid14,'right')?></td>
