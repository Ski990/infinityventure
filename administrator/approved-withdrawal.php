...
<tr><td>
<div align="left" style="margin-left:; font-size:14px;"><strong>Total_Request_Amount&nbsp;:&nbsp;</strong>Rs.&nbsp;<?=getApprovedTotalWithdrawal($conn,'request')?></div>
</td>
<td>
<div align="center" style="padding:10px;font-size:14px;">
<strong>Total_Charge&nbsp;:&nbsp;</strong>Rs.&nbsp;<?=getApprovedTotalWithdrawal($conn,'tds')+getApprovedTotalWithdrawal($conn,'service')?></div>
</td>
<td>
<div align="right" style="padding:10px;font-size:14px; margin-right:-10px;">
<strong>Total_Payout&nbsp;:&nbsp;</strong>Rs.&nbsp;<?=getApprovedTotalWithdrawal($conn,'payout')?></div>
</td>
</tr>
</table>
...
<td width="6%" align="center">Wallet</td>
...
<td width="6%" align="center">Approved</td>
</tr>
</thead>
<tbody>
<?php
...
<?php $i++;}}else{?>
<tr height="15"><td align="center" colspan="16" style="color:#FF0000;"><div class="norecord">No Record Found!</div></td></tr>
<?php }?>
</tbody>
</table>
</div>
