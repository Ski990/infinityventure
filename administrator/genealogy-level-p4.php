...
<h4 class="card-title" align="left"><?=getSettingsPackagename($conn,'P4','packagename')?> Level View</h4>
...
$sql="SELECT * FROM `iv_genealogy_p4` ORDER BY `id` LIMIT 1";
}
$res=query($conn,$sql);
$num=numrows($res);
$i=0;
...
<td align="center" style="padding:5px;"><a href="genealogy-level-p4.php?placement=<?=$fetch['userid']?>"><?=$fetch['userid']?></a></td>
...
<tr>
<td align="center" style="padding:3px;"><?=($i+1)?></td>
<td align="center" style="padding:5px;"><a href="genealogy-level-p4.php?placement=<?=$fetch1['userid']?>"><?=$fetch1['userid']?></a></td>
...
<tr>
<td align="center" style="padding:3px;"><?=($i+1)?></td>
<td align="center" style="padding:5px;"><a href="genealogy-level-p4.php?placement=<?=$fetch2['userid']?>"><?=$fetch2['userid']?></a></td>
...
<tr>
<td align="center" style="padding:3px;"><?=($i+1)?></td>
<td align="center" style="padding:5px;"><a href="genealogy-level-p4.php?placement=<?=$fetch3['userid']?>"><?=$fetch3['userid']?></a></td>
...
<tr>
<td align="center" style="padding:3px;"><?=($i+1)?></td>
<td align="center" style="padding:5px;"><a href="genealogy-level-p4.php?placement=<?=$fetch4['userid']?>"><?=$fetch4['userid']?></a></td>
...
<tr>
<td align="center" style="padding:3px;"><?=($i+1)?></td>
<td align="center" style="padding:5px;"><a href="genealogy-level-p4.php?placement=<?=$fetch5['userid']?>"><?=$fetch5['userid']?></a></td>
...
<tr>
<td align="center" style="padding:3px;"><?=($i+1)?></td>
<td align="center" style="padding:5px;"><a href="genealogy-level-p4.php?placement=<?=$fetch6['userid']?>"><?=$fetch6['userid']?></a></td>
...
<tr>
<td align="center" style="padding:3px;"><?=($i+1)?></td>
<td align="center" style="padding:5px;"><a href="genealogy-level-p4.php?placement=<?=$fetch7['userid']?>"><?=$fetch7['userid']?></a></td>
...
<tr>
<td align="center" style="padding:3px;"><?=($i+1)?></td>
<td align="center" style="padding:5px;"><a href="genealogy-level-p4.php?placement=<?=$fetch8['userid']?>"><?=$fetch8['userid']?></a></td>
