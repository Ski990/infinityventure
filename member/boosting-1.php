...
<div class="card-title">Current Wallet To Boosting Wallet</div>
</div>
...
<?php if(getSettingsOnoff($conn,'currenttoboosting')=='A'){?>
<h3 align="center" style="color:#660000;">Current Wallet: <?=getAvailableWallet($conn,$userid)?> <?=$currency?></h3>
<h3 align="center" style="color:#660000;">Boosting Wallet: <?=getBoostingWallet($conn,$userid)?> <?=$currency?></h3>
<div>&nbsp;</div>
