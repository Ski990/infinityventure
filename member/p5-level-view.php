...
<div class="card-title"><a href="javascript:history.go(-1)"><img src="images/back-page.png" height="16" width="20"> &nbsp; <?=getSettingsPackagename($conn,'p5','packagename')?> Level View</a>  </div>
</div>
</div>
...
$sql="SELECT * FROM `iv_genealogy_p5`  WHERE `placement`='".trim($userid)."' ";
}
$res=query($conn,$sql);
$num=numrows($res);
$i=0;
...
<td align="center"><a href="p5-level-view.php?placement=<?=$fetch['userid']?>"><?=$fetch['userid']?></a></td>
...
<tr>
<td align="center"><?=$a?></td>
<td align="center"><a href="p5-level-view.php?placement=<?=$fetch1['userid']?>"><?=$fetch1['userid']?></a></td>
...
<tr>
<td align="center"><?=$a?></td>
<td align="center"><a href="p5-level-view.php?placement=<?=$fetch2['userid']?>"><?=$fetch2['userid']?></a></td>
...
<tr>
<td align="center"><?=$a?></td>
<td align="center"><a href="p5-level-view.php?placement=<?=$fetch3['userid']?>"><?=$fetch3['userid']?></a></td>
...
<tr>
<td align="center"><?=$a?></td>
<td align="center"><a href="p5-level-view.php?placement=<?=$fetch4['userid']?>"><?=$fetch4['userid']?></a></td>
...
<tr>
<td align="center"><?=$a?></td>
<td align="center"><a href="p5-level-view.php?placement=<?=$fetch5['userid']?>"><?=$fetch5['userid']?></a></td>
...
<tr>
<td align="center"><?=$a?></td>
<td align="center"><a href="p5-level-view.php?placement=<?=$fetch6['userid']?>"><?=$fetch6['userid']?></a></td>
...
<tr>
<td align="center"><?=$a?></td>
<td align="center"><a href="p5-level-view.php?placement=<?=$fetch7['userid']?>"><?=$fetch7['userid']?></a></td>
...
<tr>
<td align="center"><?=$a?></td>
<td align="center"><a href="p5-level-view.php?placement=<?=$fetch8['userid']?>"><?=$fetch8['userid']?></a></td>
