...
<div class="card-title"><a href="javascript:history.go(-1)"><img src="images/back-page.png" height="16" width="20"> &nbsp; Global Investment Bonus Statement</a>  </div>
</div>
</div>
<div class="row">
...
<td align="center"><?=$fetch['totalcto']?></td>
<td align="center"><?=$fetch['ctoper']?></td>
<td align="center"><?=$fetch['totalamount']?></td>
<td align="center"><?=$fetch['totalinvest']?></td>
<td align="center"><?=$fetch['ratio']?></td>
<td align="center"><?=$fetch['investamount']?></td>
<td align="center"><?=$fetch['bonus']?></td>
<td align="center"><?=$fetch['withdarawalamount']?></td>
<td align="center"><?=$fetch['globalamount']?></td>
