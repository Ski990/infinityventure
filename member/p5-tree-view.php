...
<div class="card-title"><a href="javascript:history.go(-1)"><img src="images/back-page.png" height="16" width="20"> &nbsp; <?=getSettingsPackagename($conn,'p5','packagename')?> Tree View</a>  </div>
</div>
</div>
...
{
$sqlfist="SELECT * FROM `iv_genealogy_p5` WHERE `userid`='".trim($_REQUEST['userid'])."'";
}else{
$sqlfist="SELECT * FROM `iv_genealogy_p5` WHERE `userid`='".getMember($conn,$_SESSION['mid'],'userid')."'";
}
...
<a href="p5-tree-view.php?userid=<?=$userid?>" style="text-decoration:none;">
...
<tr height="20">
<td>&nbsp;</td>
<td align="left">Left Team :&nbsp;<?=getDownlineCountP5Pair($conn,$userid,'left')?></td>
<td align="left">Right Team :&nbsp;<?=getDownlineCountP5Pair($conn,$userid,'right')?></td>
</tr>
...
<div class="boxDiv" align="center">
<?php
$userid1=getDownlineByPositionp5($conn,$userid,'Left');
if($userid1)
{
?>
<a href="p5-tree-view.php?userid=<?=$userid1?>" style="text-decoration:none;"> 
<div class="boxDiv" align="center">

<br /><div class="tooltip5">
...
<tr height="20">
<td>&nbsp;</td>
<td align="left">Left Team :&nbsp;<?=getDownlineCountP5Pair($conn,$userid1,'left')?></td>
<td align="left">Right Team :&nbsp;<?=getDownlineCountP5Pair($conn,$userid1,'right')?></td>
</tr>
...
<div class="boxDiv" align="center">
<?php
$userid3=getDownlineByPositionp5($conn,$userid1,'Left');
if($userid3)
{
?>

<a href="p5-tree-view.php?userid=<?=$userid3?>" style="text-decoration:none;">
...
<tr height="20">
<td>&nbsp;</td>
<td align="left">Left Team :&nbsp;<?=getDownlineCountP5Pair($conn,$userid3,'left')?></td>
<td align="left">Right Team :&nbsp;<?=getDownlineCountP5Pair($conn,$userid3,'right')?></td>
</tr>
...
<div class="boxDiv" align="center">
<?php
$userid7=getDownlineByPositionp5($conn,$userid3,'Left');
if($userid7)
{
?>
<div class="boxDiv" align="center">
<a href="p5-tree-view.php?userid=<?=$userid7?>" style="text-decoration:none;">
<br /><div class="tooltip5">
...
<tr height="20">
<td>&nbsp;</td>
<td align="left">Left Team :&nbsp;<?=getDownlineCountP5Pair($conn,$userid7,'left')?></td>
<td align="left">Right Team :&nbsp;<?=getDownlineCountP5Pair($conn,$userid7,'right')?></td>
</tr>
...
<div class="boxDiv" align="center">
<?php
$userid8=getDownlineByPositionp5($conn,$userid3,'Right');
if($userid8)
{
?>
<div class="boxDiv" align="center">
<a href="p5-tree-view.php?userid=<?=$userid8?>" style="text-decoration:none;">
<br />
<div class="tooltip5">
...
<tr height="20">
<td>&nbsp;</td>
<td align="left">Left Team :&nbsp;<?=getDownlineCountP5Pair($conn,$userid8,'left')?></td>
<td align="left">Right Team :&nbsp;<?=getDownlineCountP5Pair($conn,$userid8,'right')?></td>
</tr>
...
<div class="boxDiv" align="center">
<?php
$userid4=getDownlineByPositionp5($conn,$userid1,'Right');
if($userid4)
{
?>
<div class="boxDiv" align="center">
<a href="p5-tree-view.php?userid=<?=$userid4?>" style="text-decoration:none;">
<br />
...
<tr height="20">
<td>&nbsp;</td>
<td align="left">Left Team :&nbsp;<?=getDownlineCountP5Pair($conn,$userid4,'left')?></td>
<td align="left">Right Team :&nbsp;<?=getDownlineCountP5Pair($conn,$userid4,'right')?></td>
</tr>
...
<div class="boxDiv" align="center">
<?php
$userid9=getDownlineByPositionp5($conn,$userid4,'Left');
if($userid9)
{
?>
<div class="boxDiv" align="center">
<a href="p5-tree-view.php?userid=<?=$userid9?>" style="text-decoration:none;">
<br />
<div class="tooltip5">
...
<tr height="20">
<td>&nbsp;</td>
<td align="left">Left Team :&nbsp;<?=getDownlineCountP5Pair($conn,$userid9,'left')?></td>
<td align="left">Right Team :&nbsp;<?=getDownlineCountP5Pair($conn,$userid9,'right')?></td>
</tr>
...
<div class="boxDiv" align="center">
<?php
$userid10=getDownlineByPositionp5($conn,$userid4,'Right');
if($userid10)
{
?>
<div class="boxDiv" align="center">
<a href="p5-tree-view.php?userid=<?=$userid10?>" style="text-decoration:none;">
<br />
...
<tr height="20">
<td>&nbsp;</td>
<td align="left">Left Team :&nbsp;<?=getDownlineCountP5Pair($conn,$userid10,'left')?></td>
<td align="left">Right Team :&nbsp;<?=getDownlineCountP5Pair($conn,$userid10,'right')?></td>
</tr>
...
<td align="left">Approved Date:&nbsp;<?php if(getMemberUserID($conn,$userid10,'approved')){?><?=getDateConvert(getMemberUserID($conn,$userid9,'approved'))?><?php }else{?>----<?php } ?></td>
...
<div class="boxDiv" align="center">
<?php
$userid2=getDownlineByPositionp5($conn,$userid,'Right');
if($userid2)
{
?>
<div class="boxDiv" align="center">
<a href="p5-tree-view.php?userid=<?=$userid2?>" style="text-decoration:none;">
<br />
...
<tr height="20">
<td>&nbsp;</td>
<td align="left">Left Team :&nbsp;<?=getDownlineCountP5Pair($conn,$userid2,'left')?></td>
<td align="left">Right Team :&nbsp;<?=getDownlineCountP5Pair($conn,$userid2,'right')?></td>
</tr>
...
<div class="boxDiv" align="center">
<?php
$userid5=getDownlineByPositionp5($conn,$userid2,'Left');
if($userid5)
{
?>
<div class="boxDiv" align="center">
<a href="p5-tree-view.php?userid=<?=$userid5?>" style="text-decoration:none;">
<br />
...
<tr height="20">
<td>&nbsp;</td>
<td align="left">Left Team :&nbsp;<?=getDownlineCountP5Pair($conn,$userid5,'left')?></td>
<td align="left">Right Team :&nbsp;<?=getDownlineCountP5Pair($conn,$userid5,'right')?></td>
</tr>
...
<td align="left">Approved Date:&nbsp;<?php if(getMemberUserID($conn,$userid5,'approved')){?><?=getDateConvert(getMemberUserID($conn,$userid2,'approved'))?><?php }else{?>----<?php } ?></td>
...
<div class="boxDiv" align="center">
<?php
$userid11=getDownlineByPositionp5($conn,$userid5,'Left');
if($userid11)
{
?>
<div class="boxDiv" align="center">
<a href="p5-tree-view.php?userid=<?=$userid11?>" style="text-decoration:none;">
<br />
...
<tr height="20">
<td>&nbsp;</td>
<td align="left">Left Team :&nbsp;<?=getDownlineCountP5Pair($conn,$userid11,'left')?></td>
<td align="left">Right Team :&nbsp;<?=getDownlineCountP5Pair($conn,$userid11,'right')?></td>
</tr>
...
<div class="boxDiv" align="center">
<?php
$userid12=getDownlineByPositionp5($conn,$userid5,'Right');
if($userid12)
{
?>
<div class="boxDiv" align="center">
<a href="p5-tree-view.php?userid=<?=$userid12?>" style="text-decoration:none;">
<br />
<div class="tooltip5">
...
<tr height="20">
<td>&nbsp;</td>
<td align="left">Left Team :&nbsp;<?=getDownlineCountP5Pair($conn,$userid12,'left')?></td>
<td align="left">Right Team :&nbsp;<?=getDownlineCountP5Pair($conn,$userid12,'right')?></td>
</tr>
...
<td align="left">Approved Date:&nbsp;<?php if(getMemberUserID($conn,$userid12,'approved')){?><?=getDateConvert(getMemberUserID($conn,$userid11,'approved'))?><?php }else{?>----<?php } ?></td>
...
<div class="boxDiv" align="center">
<?php
$userid6=getDownlineByPositionp5($conn,$userid2,'Right');
if($userid6)
{
?>
<div class="boxDiv" align="center">
<a href="p5-tree-view.php?userid=<?=$userid6?>" style="text-decoration:none;">
<br />
...
<tr height="20">
<td>&nbsp;</td>
<td align="left">Left Team :&nbsp;<?=getDownlineCountP5Pair($conn,$userid6,'left')?></td>
<td align="left">Right Team :&nbsp;<?=getDownlineCountP5Pair($conn,$userid6,'right')?></td>
</tr>
...
<div class="boxDiv" align="center">
<?php
$userid13=getDownlineByPositionp5($conn,$userid6,'Left');
if($userid13)
{
?>
<div class="boxDiv" align="center">
<a href="p5-tree-view.php?userid=<?=$userid13?>" style="text-decoration:none;">
<br />
...
<tr height="20">
<td>&nbsp;</td>
<td align="left">Left Team :&nbsp;<?=getDownlineCountP5Pair($conn,$userid13,'left')?></td>
<td align="left">Right Team :&nbsp;<?=getDownlineCountP5Pair($conn,$userid13,'right')?></td>
</tr>
...
<div class="boxDiv" align="center">
<?php
$userid14=getDownlineByPositionp5($conn,$userid6,'Right');
if($userid14)
{
?>
<div class="boxDiv" align="center">
<a href="p5-tree-view.php?userid=<?=$userid14?>" style="text-decoration:none;">
<br />
...
<tr height="20">
<td>&nbsp;</td>
<td align="left">Left Team :&nbsp;<?=getDownlineCountP5Pair($conn,$userid14,'left')?></td>
<td align="left">Right Team :&nbsp;<?=getDownlineCountP5Pair($conn,$userid14,'right')?></td>
</tr>
