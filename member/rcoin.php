...
<div class="card-title"><a href="javascript:history.go(-1)"><img src="images/back-page.png" height="16" width="20"> &nbsp; R-Coin</a>   </div>
</div>
</div>
...
<?php if($_REQUEST['m']==1){?><div align="center" style="color:#00CC00;background:#FFFFFF;height:30px;line-height:30px;">R-Coin purchase successfully!</div><?php }?>
...
<h3 align="center" style="color:#660000;">Fund Wallet: <?=getFundWallet($conn,$userid)?></h3>

<p align="center" style="color:#FF0000; padding-bottom:8px;font-size:16px;">1 Coin =&nbsp; <?=getSettingsRcoin($conn,'coinvalue')?></p>
...
{
?>
<form class="form" action="rcoin-process.php" method="post">
<div class="col-md-12">
<div class="form-group form-group-default">
<label>No of Coin<span style="color:#CC0000;">*</span></label>
<input type="text" class="form-control" name="nocoin" placeholder="Enter No of Coin" value="" required>
</div>
</div>
<div class="col-md-12">
<div class="form-group form-group-default">
...
<div class="row mt-3">
<div class="col-md-12">
<div class="text-left mt-3 mb-3">&nbsp;&nbsp;&nbsp;&nbsp;<button class="btn btn-success">Buy Now</button>
</div>
</div>
</div>
</form>
