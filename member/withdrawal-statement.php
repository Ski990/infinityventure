...
<div class="card-title"><a href="javascript:history.go(-1)"><img src="images/back-page.png" height="16" width="20"> &nbsp; Withdrawal Statement</a>  <span style="float:right;background:;padding:3px 5px;color:#333333;"><a href="withdrawal.php?case=add" style="text-decoration:none;margin-buttom:10px;">+ New Record</a></span> </div>
</div>
</div>
<div class="row">
<div class="col-md-12">
...
$tname='iv_withdrawal';
$lim=100;
$tpage='withdrawal-statement.php';
...
<td align="center"><?=$fetch['bname']?></td>
<td align="center"><?=$fetch['branch']?></td>
<td align="center"><?=$fetch['accname']?></td>
<td align="center"><?=$fetch['accno']?></td>
<td align="center"><?=$fetch['ifscode']?></td>
