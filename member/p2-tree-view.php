...
<div class="card-title"><a href="javascript:history.go(-1)"><img src="images/back-page.png" height="16" width="20"> &nbsp; <?=getSettingsPackagename($conn,'p2','packagename')?> Tree View</a>  </div>
</div>
</div>
...
{
$sqlfist="SELECT * FROM `iv_genealogy_p2` WHERE `userid`='".trim($_REQUEST['userid'])."'";
}else{
$sqlfist="SELECT * FROM `iv_genealogy_p2` WHERE `userid`='".getMember($conn,$_SESSION['mid'],'userid')."'";
}
...
<a href="p2-tree-view.php?userid=<?=$userid?>" style="text-decoration:none;">
...
{
?>
<a href="p2-tree-view.php?userid=<?=$userid1?>" style="text-decoration:none;"> 
<div class="boxDiv" align="center">

<br /><div class="tooltip2">
...
<a href="p2-tree-view.php?userid=<?=$userid3?>" style="text-decoration:none;">
...
?>
<div class="boxDiv" align="center">
<a href="p2-tree-view.php?userid=<?=$userid7?>" style="text-decoration:none;">
<br /><div class="tooltip2">
...
?>
<div class="boxDiv" align="center">
<a href="p2-tree-view.php?userid=<?=$userid8?>" style="text-decoration:none;">
<br />
<div class="tooltip2">
...
?>
<div class="boxDiv" align="center">
<a href="p2-tree-view.php?userid=<?=$userid4?>" style="text-decoration:none;">
<br />
...
?>
<div class="boxDiv" align="center">
<a href="p2-tree-view.php?userid=<?=$userid9?>" style="text-decoration:none;">
<br />
<div class="tooltip2">
...
?>
<div class="boxDiv" align="center">
<a href="p2-tree-view.php?userid=<?=$userid10?>" style="text-decoration:none;">
<br />
...
?>
<div class="boxDiv" align="center">
<a href="p2-tree-view.php?userid=<?=$userid2?>" style="text-decoration:none;">
<br />
...
?>
<div class="boxDiv" align="center">
<a href="p2-tree-view.php?userid=<?=$userid5?>" style="text-decoration:none;">
<br />
...
?>
<div class="boxDiv" align="center">
<a href="p2-tree-view.php?userid=<?=$userid11?>" style="text-decoration:none;">
<br />
...
?>
<div class="boxDiv" align="center">
<a href="p2-tree-view.php?userid=<?=$userid12?>" style="text-decoration:none;">
<br />
<div class="tooltip2">
...
?>
<div class="boxDiv" align="center">
<a href="p2-tree-view.php?userid=<?=$userid6?>" style="text-decoration:none;">
<br />
...
?>
<div class="boxDiv" align="center">
<a href="p2-tree-view.php?userid=<?=$userid13?>" style="text-decoration:none;">
<br />
...
?>
<div class="boxDiv" align="center">
<a href="p2-tree-view.php?userid=<?=$userid14?>" style="text-decoration:none;">
<br />
