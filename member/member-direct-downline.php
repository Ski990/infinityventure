...
<div class="card-title"><a href="javascript:history.go(-1)"><img src="images/back-page.png" height="16" width="20"> &nbsp; My Sponsor Statement</a>  </div>
</div>
</div>
<div class="row">
...
<td align="center"><?php if($fetch['package']){?><?=getSettingsPackage($conn,getLatestPackage($conn,$fetch['userid'],'package'),'package')?> (<?=getLatestPackage($conn,$fetch['userid'],'amount')?>)<?php }else{?>---<?php }?></td>
<td align="center"><?=$fetch['phone']?></td>
<td align="center"><?php if($fetch['status']=='A'){?><a style="color:#00FF00;">Active</a><?php }else{?> <a style="color:#FF0000;">Inactive</a><?php }?></td>
<td align="center"><?php if($fetch['paystatus']=='I'){?><a style="color:#FF0000;">Pending</a><?php }else{?><a style="color: #00FF00;">Paid</a><?php }?></td>
