...
<div class="card-title"><a href="javascript:history.go(-1)"><img src="images/back-page.png" height="16" width="20"> &nbsp; Boosting Upgrade</a>  <span style="float:right;background:;padding:3px 5px;color:#333333;"><a href="booster-upgrade.php" style="text-decoration:none;margin-buttom:10px;">+ Upgrade</a></span> </div>
</div>
</div>
...
<tbody>
<?php
$tname='iv_member_boosting_upgrade';
$lim=100;
$tpage='boosting-upgrade-statement.php';
