...
<div class="card-title"><a href="javascript:history.go(-1)"><img src="images/back-page.png" height="16" width="20"> &nbsp; Fund to Others Transfer</a>   </div>
</div>
</div>
...
<?php if($_REQUEST['e']==1){?><div align="center" style="color:#FF0000;background:#FFFFFF;height:30px;line-height:30px;">Minimum transfer amount is Rs.  <?=getSettingsTransfer($conn,'minimum')?>!</div><?php }?>
...
<?php if($_REQUEST['s']==1){?><div align="center" style="color:#FF0000;background:#FFFFFF;height:30px;line-height:30px;">Maximum transfer amount is Rs.  <?=getSettingsTransfer($conn,'maximum')?>!</div><?php }?>

<h3 align="center" style="color:#000033;">Fund Wallet: <?=getFundWallet($conn,$userid)?></h3>
<div>&nbsp;</div>
<?php 
