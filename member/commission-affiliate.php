...
<div class="card-title"><a href="javascript:history.go(-1)"><img src="images/back-page.png" height="16" width="20"> &nbsp; Affiliate Bonus Statement</a>  </div>
</div>
</div>
...
<tbody>
<?php
$tname='iv_commission_affiliate';
$lim=100;
$tpage='commission-affiliate.php';
...
<td align="center" style="padding:2px;"><?=$fetch['fromid']?></td>
<td align="center" style="padding:2px;"><?=ucwords(getMemberUserid($conn,$fetch['fromid'],'name'))?></td>
<td align="center" style="padding:2px;"><?=$fetch['level']?></td>
<td align="center" style="padding:2px;"><?=getSettingsPackage($conn,$fetch['package'],'package')?></td>

<td align="center" style="padding:2px;"><?=$fetch['amount']?></td>
<td align="center" style="padding:2px;"><?=$fetch['bonusper']?></td>
