...
if($ava>=$amount)
{
$sql1 = "UPDATE `iv_member` SET `paystatus`='A',`package`='".$package."',`approved`='".date('Y-m-d')."' WHERE `id`='" . trim(mysqli_real_escape_string($conn, $_SESSION['mid'])) . "'";
...
$sqlb="INSERT INTO `iv_member_topup` (`userid`,`topupid`,`package`,`amount`,`date`) VALUES ('".$userid."','".$userid."','".$package."','".$amount."','".date('Y-m-d')."')";
