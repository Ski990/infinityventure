...
<div class="card-title">Boosting Upgrade</div>
</div>
...
<?php }?>
<?php }else{?>
<h3 align="center" style="font-size:18px;color:#FF0000;"><br /><a href="product.php">Click here</a> to activate your account!</h3>
<?php }?>
</div>
