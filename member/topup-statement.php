...
<div class="card-title"><a href="javascript:history.go(-1)"><img src="images/back-page.png" height="16" width="20"> &nbsp; Topup Statement</a>  <span style="float:right;background:;padding:3px 5px;color:#333333;"><a href="topup.php?case=check" style="text-decoration:none;margin-buttom:10px;">+ New Record</a></span> </div>
</div>
</div>
...
$lim=100;
$tpage='topup.php';
$where="WHERE `userid`='".getMember($conn,$_SESSION['mid'],'userid')."' AND `topupid`!='".getMember($conn,$_SESSION['mid'],'userid')."' ORDER BY `id`";
...
<td align="center"><?=ucwords(getMemberUserID($conn,$fetch['topupid'],'name'))?></td>
