...
<div class="card-title"><a href="javascript:history.go(-1)"><img src="images/back-page.png" height="16" width="20"> &nbsp; Package Upgrade Statement</a>  <span style="float:right;background:;padding:3px 5px;color:#333333;"><a href="upgrade.php" style="text-decoration:none;margin-buttom:10px;">+ New Record</a></span> </div>
</div>
</div>
<div class="row">
